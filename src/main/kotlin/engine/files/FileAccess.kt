...
class FileAccess(file: File, val Mode: FileAccessMode, val Type: FileType) : AutoCloseable {
    ...
    class ObjectWriter constructor(file: File) : Writer<Any?>() {
        private val _stream: ObjectOutputStream?
    ...
    class StringWriter(file: File) : Writer<String?>() {
        private val _stream: PrintWriter?
    ...
    class ObjectReader(file: File) : Reader<Any?>() {
        private val _stream: ObjectInputStream?
